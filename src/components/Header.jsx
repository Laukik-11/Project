...
function Header() {
  ...
  return (
    <nav className={burgerDis ? "" : "nav-right"}>
      <h1 className={burgerDis ? "title" : "title hidden"}>Buisness</h1>
      <Link
        to="/"
        className={burgerDis ? "toggle-button open" : "toggle-button"}
        onClick={handleClick}
      >
        <img src={img1} alt="" />
      </Link>
      <Link
        to="/"
        className={burgerDis ? "toggle-button" : "toggle-button open"}
        onClick={handleClick}
      >
        <img src={img2} alt="" />
      </Link>
